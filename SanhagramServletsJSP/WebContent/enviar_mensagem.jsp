...
<body>
	...
	<script>
		document.getElementById('msgm').href="UsuarioControlador?acao=lismsgm&remetente=<%=request.getSession().getAttribute("usuAutenticado")%>"+"&destinatario=<%= request.getParameter("destinatario")%>";
	</script>
