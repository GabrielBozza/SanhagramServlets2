...
<a href="UsuarioControlador?acao=lis&grupo=usuario" style="margin-left:150px;font-size:18px;color:black;font-family:Helvetica;text-decoration:none;"><i class="fa fa-fw fa-gear"></i> Lista de Usuários</a>
